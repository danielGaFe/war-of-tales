...
@export var velocidad: float = 100.0  # Velocidad a la que se mueve el mosquito por la pantalla.
@export var amplitud_zigzag: float = 30.0  #amplitud de subida y bajada del mosquito
@export var frecuencia_zigzag: float = 3.0  #frecuencia de oscilación del mosquito
