...
func _ready():
	...
	timer.timeout.connect(self.cuandoTerminaTiempo)
...
func obtener_nodo_vidas():
	vidas_nodo = get_node("/root/NIVEL4/Player_Idle/Vidas") # Obtiene el nodo de vidas del jugador en la escena principal.
